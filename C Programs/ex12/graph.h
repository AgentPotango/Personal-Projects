...
typedef struct { // a Node of a Graph
  ...
  int visited; //store visited value
} Node;
...
extern void depth_first(Graph * theGraph, int start, searchValues *values, int noOutDegNodes);
extern void breadth_first(Graph * theGraph, int start, searchValues *values);
