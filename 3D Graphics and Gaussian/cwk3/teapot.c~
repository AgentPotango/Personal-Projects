...
GLfloat matSurface[] =      { 0.0, 1.0, 1.0, 0.0 };

GLfloat purple_light[] =  { 1.0, 0.0, 1.0, 1.0 };
GLfloat pLight_position0[] = { 10.0, 10.0, 20.0, 2.0 };
...
void initialise(void) {
   ...
   glLightfv(GL_LIGHT1, GL_POSITION, pLight_position0);
   glLightfv(GL_LIGHT1, GL_DIFFUSE, purple_light);
   glLightfv(GL_LIGHT1, GL_SPECULAR, purple_light);
   ...
   switch(key) {
    ...
    case 115:
    	if (shaded == 1)
    		...
    		shaded --;
    	glShadeModel(shaded == 1 ? GL_SMOOTH : GL_FLAT);
    	glutPostRedisplay();
    	break;
