...
public class Date
{
  ...
  public Date addDay()
  {
    ...
    {
      //The day must have been the last day in the month
      //Now check for the next month
      try
      { 
      ...
      {
        //The month must have been 12
        //Now check for the first of next Year
        //This can't cause an exception due to the past exceptions
        try
        { 
  ...
  public Date addMonth()
  {
    ...
    {
    //the month could have been 12
    //or the month could not have have that specific day in it i.e. 31st
      if (day > daysInMonth(month + 1, year))
      {
        ...
        catch (Exception exception2)
        {
         //the month could still be 12
          ...
          {
            //no exceptions due to previous exceptions
            return null;
          }//catch
        }//catch       
      }
  ...
  public Date addYear()
  {
    ...
    {
      //day could be 29 and month could be 2
      try
      {
        return new Date(28, 2, year + 1);
      }//try
      catch(Exception exception2)
      {
        //no exceptions due to past exceptions
        return null;
      }//catch
    }//catch
  ...
  public Date subtractMonth() throws Exception
  {
    ...
    {
      //month could have been 1
      //day could not have been a day in that month i.e. 31st
      if (day > daysInMonth(month -1, year))
      {
        try
        {
        ...
        catch(Exception exception2)
        {
          ...
          {
            //no more exceptions due to past exceptions
            return null;
          }//catch
        }//catch
      }
  ...
  public Date subtractYear() throws Exception
  {
    ...
    {
      //returns an exception only if day is 29 and month is 2
      try
      {
