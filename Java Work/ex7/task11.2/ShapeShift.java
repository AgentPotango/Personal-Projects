...
/* This program perfoms simple calculations and manipulation of
   ...
   *   A rectangle is specified by giving the X and Y coordinates
   ...
   Follow this data, the user is prompted to specify an X offset
   and a Y offset.
   
   Thhe program creates the specified shape, and also a similiar one,
   ...
   *   The details of the original shape -- giving all the points
   (one, two, three, or four) and, for a circle, its radius.
...
public class ShapeShift
{
  ...
  public static void main(String[] args)
  {
    ...
    switch (shapeChoice)
    {
     ...
     //Rectangle.
     case 3:
       Point diag1End1 = inputPoint("Enter one corner as X YL ");
