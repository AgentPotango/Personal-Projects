...
public class CompareQuadPoly
{
  //prints the polynomial                                    
   ...
   {
     System.out.println("The Polynomial:     " + polynomial1.xSquared + "x^2 + "
  ...
  public static void main(String[] args)
  {
    ...
    {
      System.out.println("Is Less than :      " + polynomial2.xSquared
                         + "x^2 + " + polynomial2.xSingle + "x + "
                         + polynomial2.constant);
    }
    ...
    {
      System.out.println("Is Greater than :   " + polynomial2.xSquared
                         + "x^2 + " + polynomial2.xSingle + "x + "
                         + polynomial2.constant);
    } 
    ...
    {
      System.out.println("Is Equal to :       " + polynomial2.xSquared
                         + "x^2 + " + polynomial2.xSingle + "x + " 
                         + polynomial2.constant);
    }
