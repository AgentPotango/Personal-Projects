	...
	<div id="content" class="clearfix">
        ...
        ?>
			...
			<div id="commentOuter" >
				...
				<?php if ($ID == 10000)
				{
					echo '<p style =font-size:14pt;>The Great Bailey</p>';
					echo ' <p style =font-size:14pt;>The Bailinator</p>';
				}
				?>
			...
			{
			echo'
			<div class="fb-comments" data-href="http://potnoodle.cs.man.ac.uk/~hussaim2/CheapStakesFinal/Profile.php?id='.$ID.'" data-width="470" data-num-posts="10"></div>';
			}
			else
			echo'<p style =font-size:16pt;> You must be logged in to see the comments and post a comment</p>';?>
		...
		<section id="right">
			...
			<div class="getcontent">
				...
				<div class="boxy">
					...
					<span><a href="MyBets.php">See all...</a></span>
				</div>
			</div>
		</section>
	</div>
