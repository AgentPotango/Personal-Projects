...
<div id="Name">
  ...
  <form id="event" action="makeEvent.php"> 
...
<div id="Category">
 ...
 <div id="Description">
    ...
    <a href="#"><img src="img/user_avatar.jpg" width="300" height="300"></a>
...
<?php
  ...
  echo '
    ...
    <div id="choice">
       ...
       <input id="ch'.$i.'" name="ch'.$i.'" placeholder="ch'.$i.'" required="" type="text"> 
      
    </div>'
 ?>

<!--
<button onclick="addNewChoice('$nextChoice')" >Add New Choice</button>
<script>funtion addNewChoice($numberOfChoices)
        {
...
$nextPage = $_GET['choices'] + 1;
$nextPageLink = "createEvent.php?choices=".$nextPage;
echo '<a href="'.$nextPageLink.'">Add More Choices</a>'; ?> 
...
<div id="button">
      ...
      <input class="submit" name="submit" id="submit"a value="Submit Event" type="submit" style="width:200px; height:60px;"> 	 </p>
 </div>
   </form> 
</div>      
</div>
