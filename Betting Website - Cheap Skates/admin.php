...
<!-- EVENT EDITING ////////////////////////////////////////////////////////////////////////////////////// -->
<?php tab('End Events'); ?>
<p>Add results to events</p>

<?php
  if (authenticated == true)
  {
  echo '<center><table border="1"><td>eventID</td><td>EventName</id>
        <td>StartDate</td><td>EndDate</td><td>Choices</td><tr>';
  ...
  while ($row = mysql_fetch_array($eventQuery))
  {
    ...
    echo "<td>$endTime</td>";
    //Choices
    $choicesQuery = mysql_query("SELECT * FROM csChoices WHERE EventID = $idOfEvent");
    $numberOfChoices = mysql_num_rows($choicesQuery);
    while ($choice = mysql_fetch_array($choicesQuery))
    {
      $choiceName = $choice['ChoiceName'];
      $choiceID = $choice['ChoiceID'];
      echo "<td>$choiceName"."  ($choiceID)"."</td>";
    }
 ...
 <form id="editEvent" action="eventupdatepre.php" method="post">
