Public Class frmLogin
    ...
    Private Sub btnLogIn_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnLogIn.Click
        If P1.SelectedItem = Password(PWC(1) - 1) And P2.SelectedItem = Password(PWC(2) - 1) And P3.SelectedItem = Password(PWC(4) - 1) And P4.SelectedItem = Password(PWC(6) - 1) Then
            frmWelcome.Show()
        Else
