Module Module1
    ...
    Sub Main()
        ...
        Do
            ...
            Loop Until (OptionSelected >= 1 And OptionSelected <= 5) Or OptionSelected = 9
            Console.WriteLine()
            If OptionSelected >= 1 And OptionSelected <= 5 Then
                Select Case OptionSelected
                    ...
                    Case 5 : NameChange(PlayerOneName, PlayerTwoName)
                    Case 6 : ResetHighScores(TopScores)
                End Select
            End If
    ...
    Sub DisplayMenu()
        ...
        Console.WriteLine("5.  Change Player Name")
    ...
    Function GetMenuChoice() As Integer
        ...
        If OptionChosen < 1 Or (OptionChosen > 5 And OptionChosen <> 9) Then
            Console.WriteLine()
  ...
  ByVal PlayerScore As Integer)
    ...
    Sub DisplayTopScores(ByVal TopScores() As TTopScore)
        ...
        Next
        If NoTopScores Then
            Console.WriteLine("There are Currently No Top Scores")
        End If
        Console.WriteLine()
  ...
  ByVal VirtualDiceGame As Boolean, ByRef TopScores() As TTopScore)
    ...
    Sub NameChange(ByRef Name1 As String, ByRef Name2 As String)
        Console.Write("What is Player One's Name?")
        Name1 = GetValidPlayerName()
        Console.Write("What is Player Two's Name?")
        Name2 = GetValidPlayerName()
    End Sub

    Sub ResetHighScores(ByRef Score)
